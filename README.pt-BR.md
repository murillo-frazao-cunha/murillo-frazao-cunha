...
- Infraestrutura Docker e orquestração de containers
- Sistemas Linux e automação
- Sistemas de comunicação em tempo real
- Arquiteturas backend de alta performance
...
- 🐳 [Lunar Panel](https://github.com/murillo-frazao-cunha/panel)  
  Plataforma de gerenciamento de infraestrutura e containers.

- 🚀 [Lunar Plume](https://github.com/murillo-frazao-cunha/plume)  
  Daemon de alta performance escrito em C# para comunicação e orquestração Docker.
